# --- !Ups
insert into user (email,name,password,role) values ( 'colm@ofm.com', 'Colm Dunne', 'password', 'admin' );
insert into user (email,name,password,role) values ( 'conor@ofm.com', 'Conor McDonnell', 'password', 'admin' );
